...
class TestAugmentDartDocs(unittest.TestCase):
    ...
    def test_augment_adds_methods_section(self):
        ...
        assert "- [doSomething](methods/doSomething.md)" in content
        assert "- [dispose](methods/dispose.md)" in content
    ...
    def test_augment_adds_properties_and_constructors(self):
        ...
        assert "- [propA](properties/propA.md)" in content
        assert "## Constructors" in content
        assert "- [MyClass](constructors/MyClass.md)" in content
    ...
    def test_augment_is_idempotent(self):
        ...
        assert content_pass_1 == content_pass_2
        # Ensure we didn't duplicate sections
        assert content_pass_2.count("## Methods") == 1
