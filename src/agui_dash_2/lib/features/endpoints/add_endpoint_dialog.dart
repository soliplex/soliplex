...
import '../../core/models/completions_presets.dart';
import '../../core/models/endpoint_models.dart';
import '../../core/models/saved_endpoint.dart';
import '../../core/services/completions_probe.dart';
import '../../core/services/endpoint_config_service.dart';
...
class AddEndpointDialog extends ConsumerStatefulWidget {
  ...
  static Future<SavedEndpoint?> show(
    ...
    return showDialog<SavedEndpoint>(
      context: context,
      builder: (context) => AddEndpointDialog(existingEndpoint: existingEndpoint),
    );
  }
  ...
  void initState() {
    ...
    if (_isEditing) {
      ...
      if (endpoint.isCompletions) {
        ...
        // _availableModels = completions.availableModels ?? []; // Removed from model
      ...
      setState(() {
        ...
        if (result.isReachable) {
          ...
          if (_nameController.text.isEmpty) {
            final preset = CompletionsProviderPresets.byUrl(_urlController.text);
