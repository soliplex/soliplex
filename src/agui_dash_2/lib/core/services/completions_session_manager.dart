...
import '../chat/completions_chat_session.dart';
import '../chat/chat_session.dart';
import '../chat/unified_message.dart';
import '../models/chat_models.dart';
import '../models/saved_endpoint.dart';
...
class CompletionsSessionState {
  ...
  CompletionsSessionState copyWith({
    ...
    return CompletionsSessionState(
      activeEndpoint: clearEndpoint ? null : (activeEndpoint ?? this.activeEndpoint),
...
class CompletionsSessionManager extends StateNotifier<CompletionsSessionState> {
  ...
  Future<void> clearEndpoint() async {
    ...
    DebugLog.service('CompletionsSessionManager: Cleared endpoint, back to AG-UI mode');
  }
...
final completionsSessionManagerProvider =
    StateNotifierProvider<CompletionsSessionManager, CompletionsSessionState>((ref) {
...
final completionsMessageStreamProvider =
...
ChatMessage _unifiedToChatMessage(UnifiedMessage msg) {
  switch (msg) {
    case TextMessage(:final id, :final role, :final content, :final timestamp, :final isStreaming):
    ...
    case ThinkingMessage(:final id, :final content, :final timestamp, :final isStreaming):
    ...
    case ToolCallMessage(:final id, :final toolName, :final timestamp, :final status):
    ...
    case RichContentMessage(:final id, :final timestamp, :final contentType, :final payload):
