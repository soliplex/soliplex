...
class CompletionsEndpoint extends EndpointConfiguration {
  ...
  // Note: API Keys are stored separately in SecureStorage, keyed by the server ID.
  ...
  @override
  List<Object?> get props => [type, url, label, model, availableModels, supportsModelDiscovery];
