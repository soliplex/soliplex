...
import 'package:agui_dash_2/core/network/network_inspector_models.dart';
  ...
  group('NetworkInspector', () {
    ...
    group('dispose', () {
      test('closes update stream', () async {
        // Create a separate inspector for this test to avoid conflict with tearDown
        final disposableInspector = NetworkInspector(maxEntries: 10);

        final completer = Completer<void>();
        disposableInspector.updates.listen(
          (_) {},
