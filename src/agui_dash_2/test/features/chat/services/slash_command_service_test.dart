...
void main() {
  group('SlashCommandService', () {
    ...
    group('handleCommand', () {
      test(
        '/search command calls session.addUserMessage and session.addGenUiMessage',
        () {
      ...
      test(
        '/list projects command calls session.addUserMessage and multiple session.addGenUiMessage',
        () {
      ...
      test(
        '/list demos command calls session.addUserMessage and session.addSystemMessage',
        () {
      ...
      test(
        '/demo command calls session.addUserMessage and session.addSystemMessage',
        () {
      ...
      test(
        '/canvas command calls session.addUserMessage and session.addSystemMessage',
        () {
