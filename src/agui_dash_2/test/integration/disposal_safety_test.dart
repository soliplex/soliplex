...
import 'package:agui_dash_2/core/router/app_router.dart'; // Added for routerProvider
import 'package:agui_dash_2/features/navigation/app_scaffold.dart'; // Added for AppScaffold
...
class MockAppStateManager extends Mock implements app_state_manager.AppStateManager {
    ...
    await tester.pumpWidget(
      ProviderScope(
        overrides: [
          ...
          app_providers.appStateManagerProvider.overrideWith((ref) => mockAppStateManager),
          activeMessageStreamProvider.overrideWith((ref) => const AsyncData([])),
          routerProvider.overrideWith((ref) => GoRouter(
                navigatorKey: GlobalKey<NavigatorState>(debugLabel: 'test_router'),
                initialLocation: '/chat',
                routes: [
                  ShellRoute(
                    navigatorKey: GlobalKey<NavigatorState>(debugLabel: 'test_shell_router'),
