...
## 3. The GenUI System
**Critical Finding:** The application does **NOT** use the `rfw` (Remote Flutter Widgets) package. Instead, it implements a custom **Registry + Factory** pattern to render dynamic UI.
