...
_hidden_alias("check-config", audit.check_config)
_hidden_alias("list-secrets", audit.list_secrets)
_hidden_alias("list-environment", audit.list_environment)
_hidden_alias("list-oidc-auth-providers", audit.list_oidc_auth_providers)
_hidden_alias("list-rooms", audit.list_rooms)
_hidden_alias("list-completions", audit.list_completions)
_hidden_alias("list-skills", audit.list_skills)
